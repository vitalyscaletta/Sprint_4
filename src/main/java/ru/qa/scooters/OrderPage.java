...
public class OrderPage {
    ...
    public static final By WHEN_DELIVERY_PICKER = By.xpath("//input[@placeholder='* Когда привезти самокат']");
    public static final By WHEN_DELIVERY_DAY = By.className("react-datepicker__day--020");
